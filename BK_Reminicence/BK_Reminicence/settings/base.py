...
WSGI_APPLICATION = 'BK_Reminicence.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'applications.core.exceptions.custom_exception_handler',
}
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Reminiscence Music API',
    'DESCRIPTION': 'API para gestión de música con integración de Spotify',
    'VERSION': '1.0.0',
